...
function TTrack1=TestmultiObjectTracking(track)
...
% foreground objects, and displaying results.
    ...
    function obj = setupSystemObjects()
        ...
        obj.reader = vision.VideoFileReader('data/v2_down1.mp4');
        ...
        obj.detector = vision.ForegroundDetector('NumGaussians', 5, ...
            'NumTrainingFrames', 8, 'MinimumBackgroundRatio', 0.5,'LearningRate', 0.0001);
